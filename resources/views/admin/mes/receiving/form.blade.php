                    ...
                    <div class="form-grid-3">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                <svg class="ico" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                                    <line x1="16" y1="2" x2="16" y2="6" />
                                    <line x1="8" y1="2" x2="8" y2="6" />
                        ...
                        <div class="field full">
                            ...
                            <div class="sdd" id="sdd_supplier_id">
                                <div class="sdd-trigger" onclick="toggleSdd('supplier_id')">
                                    <svg style="position:absolute;left:13px;top:50%;transform:translateY(-50%);width:15px;height:15px;stroke:var(--text-muted);fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;pointer-events:none"
                                        viewBox="0 0 24 24">
                                    ...
                                    <span class="sdd-trigger-text placeholder" id="sdd_supplier_id_label"
                                        data-placeholder="Select a supplier...">Select a supplier...</span>
                                    <svg class="sdd-clear" onclick="clearSdd('supplier_id',event)" viewBox="0 0 24 24">
                    ...
                    <div class="form-grid-3">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" step="0.01" id="invoice_qty" name="invoice_qty" placeholder="0.00"
                                    required>
                            </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" step="0.01" id="received_qty" name="received_qty" placeholder="0.00"
                                    required>
                            </div>
                        ...
                        <div class="field full">
                            ...
                            <textarea id="remarks" name="remarks" class="no-icon"
