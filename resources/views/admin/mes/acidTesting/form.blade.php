      ...
      <div style="padding:16px 20px 20px">
        ...
        <div class="result-banner" id="resultBanner">
          <div>
            ...
            <div class="rb-sub">(WEIGHT DIFFERENCE / INITIAL WEIGHT) * 100</div>
          </div>
  ...
  <script>
    ...
    async function loadRecord() {
      ...
      (data.details ?? []).forEach(row => {
        const frontUlabType = parseInt(row.ulab_type) < 1000024 ? '5' : row.ulab_type;
        addRow({
          pallet_no: row.pallet_no,
          ulab_type: frontUlabType,
    ...
    function recalcTotals() {
      ...
      const netPct = tInit > 0 ? ((tInit - tDrained) / tInit) * 100 : null;
    ...
    function addRow(data = {}) {
      ...
      const isAcid = (data.ulab_type ?? '') == 5 || (data.ulab_type ?? '') == 1000025;
    ...
    function onUlabChange(idx) {
      ...
      const isAcid = ulab == 5 || ulab == 1000025;
    ...
    function buildPayload() {
      ...
      document.querySelectorAll('#palletBody tr').forEach((tr, i) => {
        ...
        const isAcid = ulab === ACID_PRESENT || ulab == 1000025;
